...
RSpec.describe 'POST /graphql', type: :request do
  ...
  let!(:user3) { User.create(email: 'test3@gmail.com', password: "5646546", authentication_token: 'gdhhfdhdfhfhf', admin: true) }

  describe 'requests query' do
